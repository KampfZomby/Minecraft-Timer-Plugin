...
public class TimerCommand implements CommandExecutor {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "set": {
                ...
                try {
                    ...
                    sender.sendMessage(ChatColor.GREEN + ">> " + ChatColor.RESET + "Timer was set to " + ChatColor.LIGHT_PURPLE + args[1]);
    ...
    private void mode(CommandSender sender) {
        ...
        if (timer.isTimerMode()) {
            ...
            sender.sendMessage(ChatColor.GREEN + ">> " + ChatColor.RESET + "Your timer is now counting"  + ChatColor.LIGHT_PURPLE + " forward");
            timer.setRunning(false);
        } else if (!timer.isTimerMode()) {
            timer.setTime(3600);
            timer.setTimerMode(true);
            sender.sendMessage(ChatColor.GREEN + ">> " + ChatColor.RESET + "Your timer is now counting" + ChatColor.LIGHT_PURPLE + " backward");
            timer.setRunning(false);
        }
    }
    ...
    public void timer(CommandSender sender) {
        ...
        im4 = is4.getItemMeta();
        assert im4 != null;
        im4.setDisplayName(ChatColor.DARK_PURPLE + "Reset Timer");
        ...
        if (timer.isTimerMode()) {
            ...
            im8 = is8.getItemMeta();
            assert im8 != null;
            im8.setDisplayName(ChatColor.DARK_PURPLE + "Timer forwards");
            ...
            im8 = is8.getItemMeta();
            assert im8 != null;
            im8.setDisplayName(ChatColor.DARK_PURPLE + "Timer backwards");
